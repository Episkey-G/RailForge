...
- Hosted Codex path:
  - Run `python -m railforge prepare-execution --workspace <workspace> --profile real`
  ...
  - Run `python -m railforge record-execution --workspace <workspace> --profile real --file <result.json>`
